...
All pins that are hooked up directly to the CPU can be used for blade detect, so data pins, free pins, button pins and RX/TX, except Data1on a 3.9 board because it’s already bridged to a resistor.  
