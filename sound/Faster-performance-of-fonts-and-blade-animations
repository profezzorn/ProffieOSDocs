...
while single files, such as lock01.wav should live in the font root. See attached image for a visual of this.

As per Fredrik Hubinette, the current ProffieOS will perform best if you cater to the way that FAT32 formatting works.
FAT32 format:
