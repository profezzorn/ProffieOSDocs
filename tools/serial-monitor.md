...
see [Serial Monitor Commands](/tools/serial-monitor-commands.html).  
For additional available commands, see [Serial Monitor Additional Commands](/tools/serial-monitor-additional-commands.html).
