...
## [alt.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/alt.h)
// Usage: AltF
...
## [battery_level.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/battery_level.h)
// Usage: BatteryLevel
    // Returns 0-32768 based on battery level.
    // returned value: INTEGER

## [blade_angle.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/blade_angle.h)
...
## [blast.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/blast.h)
...
## [blinking.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/blinking.h)
...
## [brown_noise.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/brown_noise.h)
...
## [bullet_count.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/bullet_count.h)
// Usage: BulletCount
...
## [bump.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/bump.h)
...
## [center_dist.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/center_dist.h)
// Usage: Remap<CenterDistF<CENTER>,COLOR>
    // Distributes led COLOR from CENTER
    // CENTER : FUNCTION (defaults to Int<16384>)

## [change_slowly.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/change_slowly.h)
// Usage: ChangeSlowly<F, SPEED>
    // Changes F by no more than SPEED values per second.
    // F, SPEED: FUNCTION
    // return value: FUNCTION, same for all LEDs

## [circular_section.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/circular_section.h)
...
## [clamp.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/clamp.h)
...
## [clash_impact.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/clash_impact.h)
...
## [divide.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/divide.h)
// Usage: Divide<F, V>
    // Divide F by V
    // If V = 0, returns 0
    // F, V: FUNCTION, 
...
## [effect_increment.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/effect_increment.h)
...
## [effect_position.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/effect_position.h)
...
## [hold_peak.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/hold_peak.h)
...
## [ifon.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/ifon.h)
// Usage: Ifon<A, B>
...
## [increment.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/increment.h)
...
## [int.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/int.h)
// Usage: Int<N>
    // Returns N
    // N: a number
    // return value: INTEGER

## [int_arg.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/int_arg.h)

## [int_select.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/int_select.h)
...
## [isbetween.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/isbetween.h)
// Usage: IsBetween<F, BOTTOM, TOP>
    // Returns 0 or 32768 based F > BOTTOM and < TOP 
    // F, BOTTOM, TOP: INTEGER
    // return value: INTEGER

## [islessthan.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/islessthan.h)
...
## [layer_functions.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/layer_functions.h)
...
## [linear_section.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/linear_section.h)
...
## [marble.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/marble.h)
...
## [mod.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/mod.h)
// Usage: ModF<F, MAX>
    // F: FUNCTION
...
## [mult.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/mult.h)
// Usage: Mult<F, V>
...
## [on_spark.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/on_spark.h)
...
## [ramp.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/ramp.h)
// Usage: Remap<RampF,COLOR>
    // Returns led as value between 0 ~ 32768
    // Keeps existing mapping for pixels when used with Remap<>

## [random.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/random.h)
// Usage: RandomF
    // Return value: FUNCTION
...
## [random_blink.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/random_blink.h)
...
## [readpin.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/readpin.h)
// Usage: ReadPinF<PIN>
...
## [scale.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/scale.h)
// Usage: Scale<F, A, B>
    // Changes values in range 0 - 32768 to A-B
    // F, A, B: INTEGER
    // return value: INTEGER

## [sequence.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/sequence.h)
...
## [sin.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/sin.h)
...
## [slice.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/slice.h)
...
## [smoothstep.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/smoothstep.h)
...
## [sound_level.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/sound_level.h)
...
## [sparkle.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/sparkle.h)
// Usage: SparkleF<SPARK_CHANCE_PROMILLE, SPARK_INTENSITY>
    // SPARK_CHANCE_PROMILLE: a number
    // SPARK_INTENSITY: a number

## [strobe.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/strobe.h)
...
## [subtract.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/subtract.h)
// Usage: Subtract<A, B>
    // Subtracts B from A (A - B)
    // A, B: FUNCTION
    // return value: FUNCTION

## [sum.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/sum.h)
// Usage: SUM<A, B, ...>
    // Adds A + B...
    // A, B: INTEGER
    // return value: INTEGER

## [svf.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/svf.h)

## [swing_speed.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/swing_speed.h)
...
## [time_since_effect.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/time_since_effect.h)
...
## [trigger.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/trigger.h)
...
## [twist_angle.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/twist_angle.h)
...
## [variation.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/variation.h)
// Usage: Variation
...
## [volume_level.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/volume_level.h)
// Usage: VolumeLevel
    // Returns 0-32768 based on volume level.
    // returned value: INTEGER

## [wavlen.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/wavlen.h)
// Usage: WavLen<>
    // Or: WavLen<EFFECT>
    // EFFECT: effect type
    // return value: INTEGER
...
## [wavnum.h](https://github.com/profezzorn/ProffieOS/blob/master/functions/wavnum.h)
// Usage: WavNum<>
    // Or: WavNum<EFFECT>
    // EFFECT: effect type
    // return value: INTEGER
