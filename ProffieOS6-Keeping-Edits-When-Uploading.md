In ProffieOS6, all edits made to your presets or settings in either [Edit Mode](https://fett263.s3.us-east-2.amazonaws.com/proffieOS6-edit-mode.html) or using [ProffieOS Workbench (WebUSB)](https://github.com/profezzorn/ProffieOS/wiki/WebUSB) are saved to your SD card in various *.ini files.  
...
and change the "14" to any number between 0 and 13 corresponding to the style you want.  See [Edit presets.ini by Hand](https://github.com/profezzorn/ProffieOS/wiki/Editing-presets.ini-by-hand) for more information.
