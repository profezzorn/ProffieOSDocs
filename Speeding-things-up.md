...
Lots of things gets faster when you turn on optimization. However, they also get bigger, so you may run out of flash memory. See the [[Saving Memory]] page for how to reduce flash memory usage.
